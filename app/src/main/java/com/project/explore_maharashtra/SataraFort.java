...
public class SataraFort extends AppCompatActivity {
    NeumorphCardView cr,cr1,cr2,cr3,cr4,cr5,cr6,cr7,cr8,cr9;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_satara_fort);

        cr=findViewById(R.id.cardRight);
        cr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortBhushan.class);
        ...
        cr1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortKamalgad.class);
                startActivity(intent);
            }
        });
        ...
        cr2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortSajjangad.class);
                startActivity(intent);
            }
        });
        ...
        cr3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortAjinkya.class);
                startActivity(intent);
            }
        });
        ...
        cr4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortChandan.class);
                startActivity(intent);
            }
        ...
        cr5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortPandav.class);
                startActivity(intent);
            }
        ...
        cr6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortKenjalgad.class);
                startActivity(intent);
            }
        ...
        cr7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortBhai.class);
                startActivity(intent);
            }
        ...
        cr8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortKalyan.class);
                startActivity(intent);
            }
        });
        ...
        cr9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(SataraFort.this,SataraFortVasota.class);
                startActivity(intent);
            }
        });
    }
