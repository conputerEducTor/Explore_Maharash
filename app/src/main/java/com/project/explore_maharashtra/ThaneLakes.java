...
public class ThaneLakes extends AppCompatActivity {
    NeumorphCardView cr,cr1,cr2,cr3,cr4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thane_lakes);
        cr=findViewById(R.id.cardRight);
        cr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ThaneLakes.this,ThaneLakesMasunda.class);
        ...
        cr1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ThaneLakes.this,ThaneLakesKachrali.class);
                startActivity(intent);
            }
        ...
        cr2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ThaneLakes.this,ThaneLakesMakhmali.class);
                startActivity(intent);
            }
        ...
        cr3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ThaneLakes.this,ThaneLakesUpvan.class);
                startActivity(intent);
            }
        ...
        cr4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ThaneLakes.this,ThaneLakesBramhala.class);
                startActivity(intent);
            }
        });
    }
